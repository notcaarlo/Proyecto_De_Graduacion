...
if __name__ == '__main__':
    ...
    optimizer = Adam(model_ft.fc.parameters(), lr=Config.LEARNING_RATE)  # Solo optimizar la capa final

    # Cargar los datos (asumiendo que ya tienes esta función configurada)
    data_dir = 'c:/Users/Carlo/Desktop/Proyecto/Proyecto_De_Graduacion/data/dataset-trash'  # Cambia esto a tu ruta de datos
    ...
    # Asegurarse de que la carpeta 'modelos' exista
