...
def dashboard():
    ...
    # === 2. GRÁFICO 1: "ALERTAS POR HORA DEL DÍA" (Filtrado) ===
    alertas_por_hora_db = (
        db.session.query(
            func.extract('hour', Alerta.hora).label('hora'), 
    ...
    # (Esta tabla siempre muestra el "ahora", no se debe filtrar por rango)
    jornadas_activas = (
...
def estadisticas_usuario(id_usuario):
    ...
    # ... (copia y pega el resto de la función que ya tenías)
